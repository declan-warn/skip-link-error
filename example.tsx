...
const BasicGrid = () => {
  ...
  const toggleFixed = (slotName: SlotName) => {
    setGridState({
      ...gridState,
      [`is${slotName}Fixed`]:
        !gridState[`is${slotName}Fixed` as InitialStateKeys],
    });
  };
  const toggleScrollable = (slotName: SlotName) => {
    setGridState({
      ...gridState,
      [`is${slotName}Scrollable`]:
        !gridState[`is${slotName}Scrollable` as InitialStateKeys],
    });
  };
  const toggleShown = (slotName: SlotName) => {
    setGridState({
      ...gridState,
      [`is${slotName}Shown`]:
        !gridState[`is${slotName}Shown` as InitialStateKeys],
    });
  };
